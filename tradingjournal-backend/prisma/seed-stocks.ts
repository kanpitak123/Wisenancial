...
const stockUniverse: StockSeed[] = [
  ...
  // ── SET50/SET100 เพิ่มเติม ─────────────────────────────────────────────────
  // เดิมมีหุ้นไทย 44 ตัวเทียบกับสหรัฐ 95 ตัว ทำให้ผลลัพธ์ของ /stocks/radar และ
  // ช่องค้นหาเอียงไปทางหุ้นสหรัฐชัดเจน ชุดนี้เติมให้สองฝั่งเท่ากันที่ 95 ตัว
  // และกระจายครบทุก sector ที่ใช้อยู่ ไม่ได้กระจุกที่ธนาคาร/พลังงานเหมือนชุดเดิม
  //
  // มีแค่ 4 ฟิลด์ตาม StockSeed — ไม่มีราคาในนี้ ราคามาจาก MarketDataService ตอน runtime
  { symbol: 'TCAP.BK', name: 'Thanachart Capital', sector: 'Financials', exchange: 'SET' },
  { symbol: 'MTC.BK', name: 'Muangthai Capital', sector: 'Financials', exchange: 'SET' },
  { symbol: 'SAWAD.BK', name: 'Srisawad Corporation', sector: 'Financials', exchange: 'SET' },
  { symbol: 'TIDLOR.BK', name: 'Ngern Tid Lor', sector: 'Financials', exchange: 'SET' },
  { symbol: 'KTC.BK', name: 'Krungthai Card', sector: 'Financials', exchange: 'SET' },
  { symbol: 'AEONTS.BK', name: 'Aeon Thana Sinsap (Thailand)', sector: 'Financials', exchange: 'SET' },
  { symbol: 'BAM.BK', name: 'Bangkok Commercial Asset Management', sector: 'Financials', exchange: 'SET' },
  { symbol: 'BLA.BK', name: 'Bangkok Life Assurance', sector: 'Financials', exchange: 'SET' },
  { symbol: 'TQM.BK', name: 'TQM Alpha', sector: 'Financials', exchange: 'SET' },
  { symbol: 'BANPU.BK', name: 'Banpu', sector: 'Energy', exchange: 'SET' },
  { symbol: 'SPRC.BK', name: 'Star Petroleum Refining', sector: 'Energy', exchange: 'SET' },
  { symbol: 'BSRC.BK', name: 'Bangchak Sriracha', sector: 'Energy', exchange: 'SET' },
  { symbol: 'BPP.BK', name: 'Banpu Power', sector: 'Utilities', exchange: 'SET' },
  { symbol: 'EA.BK', name: 'Energy Absolute', sector: 'Utilities', exchange: 'SET' },
  { symbol: 'GUNKUL.BK', name: 'Gunkul Engineering', sector: 'Utilities', exchange: 'SET' },
  { symbol: 'TTW.BK', name: 'TTW Public Company', sector: 'Utilities', exchange: 'SET' },
  { symbol: 'WHAUP.BK', name: 'WHA Utilities and Power', sector: 'Utilities', exchange: 'SET' },
  { symbol: 'TPIPP.BK', name: 'TPI Polene Power', sector: 'Utilities', exchange: 'SET' },
  { symbol: 'IVL.BK', name: 'Indorama Ventures', sector: 'Materials', exchange: 'SET' },
  { symbol: 'SCCC.BK', name: 'Siam City Cement', sector: 'Materials', exchange: 'SET' },
  { symbol: 'TASCO.BK', name: 'Tipco Asphalt', sector: 'Materials', exchange: 'SET' },
  { symbol: 'TPIPL.BK', name: 'TPI Polene', sector: 'Materials', exchange: 'SET' },
  { symbol: 'STA.BK', name: 'Sri Trang Agro-Industry', sector: 'Materials', exchange: 'SET' },
  { symbol: 'STEC.BK', name: 'Sino-Thai Engineering and Construction', sector: 'Industrials', exchange: 'SET' },
  { symbol: 'CK.BK', name: 'CH. Karnchang', sector: 'Industrials', exchange: 'SET' },
  { symbol: 'ITD.BK', name: 'Italian-Thai Development', sector: 'Industrials', exchange: 'SET' },
  { symbol: 'AAV.BK', name: 'Asia Aviation', sector: 'Industrials', exchange: 'SET' },
  { symbol: 'BA.BK', name: 'Bangkok Airways', sector: 'Industrials', exchange: 'SET' },
  { symbol: 'PSL.BK', name: 'Precious Shipping', sector: 'Industrials', exchange: 'SET' },
  { symbol: 'RCL.BK', name: 'Regional Container Lines', sector: 'Industrials', exchange: 'SET' },
  { symbol: 'BCH.BK', name: 'Bangkok Chain Hospital', sector: 'Healthcare', exchange: 'SET' },
  { symbol: 'CHG.BK', name: 'Chularat Hospital', sector: 'Healthcare', exchange: 'SET' },
  { symbol: 'PR9.BK', name: 'Praram 9 Hospital', sector: 'Healthcare', exchange: 'SET' },
  { symbol: 'STGT.BK', name: 'Sri Trang Gloves (Thailand)', sector: 'Healthcare', exchange: 'SET' },
  { symbol: 'TU.BK', name: 'Thai Union Group', sector: 'Consumer Staples', exchange: 'SET' },
  { symbol: 'GFPT.BK', name: 'GFPT Public Company', sector: 'Consumer Staples', exchange: 'SET' },
  { symbol: 'TFG.BK', name: 'Thaifoods Group', sector: 'Consumer Staples', exchange: 'SET' },
  { symbol: 'TVO.BK', name: 'Thai Vegetable Oil', sector: 'Consumer Staples', exchange: 'SET' },
  { symbol: 'ICHI.BK', name: 'Ichitan Group', sector: 'Consumer Staples', exchange: 'SET' },
  { symbol: 'SAPPE.BK', name: 'Sappe Public Company', sector: 'Consumer Staples', exchange: 'SET' },
  { symbol: 'CENTEL.BK', name: 'Central Plaza Hotel', sector: 'Consumer Discretionary', exchange: 'SET' },
  { symbol: 'ERW.BK', name: 'The Erawan Group', sector: 'Consumer Discretionary', exchange: 'SET' },
  { symbol: 'COM7.BK', name: 'Com7 Public Company', sector: 'Consumer Discretionary', exchange: 'SET' },
  { symbol: 'GLOBAL.BK', name: 'Siam Global House', sector: 'Consumer Discretionary', exchange: 'SET' },
  { symbol: 'DOHOME.BK', name: 'Dohome Public Company', sector: 'Consumer Discretionary', exchange: 'SET' },
  { symbol: 'PLANB.BK', name: 'Plan B Media', sector: 'Communication Services', exchange: 'SET' },
  { symbol: 'VGI.BK', name: 'VGI Public Company', sector: 'Communication Services', exchange: 'SET' },
  { symbol: 'BEC.BK', name: 'BEC World', sector: 'Communication Services', exchange: 'SET' },
  { symbol: 'MAJOR.BK', name: 'Major Cineplex Group', sector: 'Communication Services', exchange: 'SET' },
  { symbol: 'SYNEX.BK', name: 'Synnex (Thailand)', sector: 'Technology', exchange: 'SET' },
  { symbol: 'SIS.BK', name: 'SiS Distribution (Thailand)', sector: 'Technology', exchange: 'SET' },
  { symbol: 'WHA.BK', name: 'WHA Corporation', sector: 'Real Estate', exchange: 'SET' },
  { symbol: 'AMATA.BK', name: 'Amata Corporation', sector: 'Real Estate', exchange: 'SET' },
  { symbol: 'SPALI.BK', name: 'Supalai', sector: 'Real Estate', exchange: 'SET' },
  { symbol: 'AP.BK', name: 'AP (Thailand)', sector: 'Real Estate', exchange: 'SET' },
  { symbol: 'ORI.BK', name: 'Origin Property', sector: 'Real Estate', exchange: 'SET' },
  { symbol: 'SIRI.BK', name: 'Sansiri', sector: 'Real Estate', exchange: 'SET' },
];
