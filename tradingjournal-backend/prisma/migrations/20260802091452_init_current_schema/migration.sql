...
-- CreateEnum
CREATE TYPE "PostReferenceType" AS ENUM ('NONE', 'TRADE', 'STOCK_PURCHASE', 'STOCK_SALE', 'DIVIDEND', 'PORTFOLIO');
...
CREATE TABLE "posts" (
    ...
    "reference_type" "PostReferenceType" NOT NULL DEFAULT 'NONE',
...
-- CreateIndex
CREATE INDEX "posts_portfolio_id_portfolio_type_idx" ON "posts"("portfolio_id", "portfolio_type");

-- CreateIndex
CREATE INDEX "posts_asset_symbol_idx" ON "posts"("asset_symbol");

-- CreateIndex
CREATE INDEX "posts_reference_type_reference_id_idx" ON "posts"("reference_type", "reference_id");
...
-- AddForeignKey
ALTER TABLE "posts" ADD CONSTRAINT "posts_portfolio_id_fkey" FOREIGN KEY ("portfolio_id") REFERENCES "portfolios"("id") ON DELETE CASCADE ON UPDATE CASCADE;
