...
//
// อยู่บน MarketInsightsController ตัวเดียวกับ /heatmap จึงติด PaidTierGuard เหมือนกัน
// แพ็กฟรีจะได้ 403 — ปล่อย error ออกไปให้ผู้เรียกแยกเอง (เหมือน heatmap.service.ts)
// ไม่ดักกลืนไว้ในนี้
